 ...
 * @author jordy
 */
class HardcopyJournalCheckoutStrategy extends PublicationsCheckoutStrategy  {

    private static final String m_TableName = "CHECKSOUTHARDCOPYJOURNAL";
    ...
    private static final String m_TableNameHardCopyJournals = "HARDCOPYJOURNALS";
    ...
    public HardcopyJournalCheckoutStrategy(UserType userType) {
        super(userType);
    }
    ...
    public void CheckoutBook(String bookId, String userId) {  
        try{
            ...
            CheckoutStrategyHelper.DecrementHardCopyNoOfCopies(m_TableNameHardCopyJournals, 
                    m_ColNameNoOfCopies, m_ColNameBookId, bookId);
        }
        catch (Exception e) {
            Logger.getLogger(HardcopyJournalCheckoutStrategy.class.getName()).log(Level.SEVERE, null, e);
        }
    }
    ...
    public void ReturnBook(String bookId, String userId) {
        try{
            CheckoutStrategyHelper.ReturnBook(m_TableName, 
                    ...
                    m_ColNameUserId,
                    m_ColNameBookId);
            CheckoutStrategyHelper.IncrementHardCopyNoOfCopies(m_TableNameHardCopyJournals, 
                    m_ColNameNoOfCopies, m_ColNameBookId, bookId);
    ...
    private Boolean IsBookCopyAvailable(String bookId) throws Exception {
        return CheckoutStrategyHelper.getNoOfAvailableCopiesOfBook(m_TableNameHardCopyJournals,
                m_ColNameNoOfCopies,
                m_ColNameBookId,
                bookId) > 0;
    }
