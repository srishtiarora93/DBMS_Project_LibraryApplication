 ...
 * @author jordy
 */
class EcopyBooksCheckoutStrategy extends PublicationsCheckoutStrategy {

    private static final String m_Table_Name = "CHECKSOUTECOPYBOOK";
    ...
    public EcopyBooksCheckoutStrategy(UserType userType) {
        super(userType);
    }
    ...
    public void CheckoutBook(String bookId, String userId) {
        try{
            ...
            Logger.getLogger(EcopyBooksCheckoutStrategy.class.getName()).log(Level.SEVERE, null, e);
        }
    }
